...
class DatabasePersistence:
    ...
    def delete_todo_from_list(self, list_id, todo_id):
        ...
        logger.info("Exeucting query: %s with list_id: %s and id: %s", query, list_id, todo_id)
    ...
    def update_todo_status(self, list_id, todo_id, new_status):
        query = """
            ...
            """
        logger.info("Executing query: %s with new_status: %s, list_id: %s, and id: %s", query, new_status, list_id, todo_id)
